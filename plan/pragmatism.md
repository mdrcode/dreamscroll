...
**Status:** living document. Last updated 2026-09-23.
...
| Issue                                                           | Effect                                                                                                                                                                     | Why tolerated                                                                | Revisit trigger                                 |
| --------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------- | ----------------------------------------------- |
| **`/_wh/cloudtask/illuminate` route also serves future reruns** | The capture-create path submits `IlluminationTask` through the illumination queue, while the same route can later serve backfill and re-run-with-a-new-model/prompt flows. | No separate route is needed for the same task type.                          | When backfill or rerun behavior is implemented. |
